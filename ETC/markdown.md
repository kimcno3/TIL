# :pushpin: **목차**
- [Markdown이란?](#pushpinmarkdown이란)
- [Markdown 기본 문법](#pushpinmarkdown-기본-문법)
    - [1. Headers](#1-headers)
    - [2. 줄바꿈](#2-줄바꿈)
    - [3. 텍스트 강조](#3-텍스트-강조)
    - [4. 수평선](#4-수평선)
...
## **6.1. TOC 링크 작성법**
- 원하는 헤더로 이동하는 목차 텍스트에 링크를 건다.
- URL 작성시, 맨 앞에 '#'을 적은 다음, 헤더 텍스트를 그대로 옮겨 적는다.
- 띄어쓰기는 스페이스바 대신 '-'을 사용한다.
- 특수기호는 모두 생략한다.(. , - 등)

### **예시코드**
```
[1.이건 목차입니다.](#1-이건-링크가-걸린-텍스트입니다)
